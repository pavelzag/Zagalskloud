...
driver = webdriver.PhantomJS(executable_path=r'C:\phantomjs\bin\phantomjs.exe') #Local
#driver = webdriver.PhantomJS(executable_path='/home/PavelZagalsky/node_modules/phantomjs/lib/phantom/bin/phantomjs') #Cloud
...
class runSelenium:
    ...
    def getAmountOfFollowings(name):
        ...
        driver.get(userURL)
        #driver.get_screenshot_as_png('something.png')
    ...
    def selectTheFollowee(followerid):
        ...
        print('The artist link is ' + artistLink)
